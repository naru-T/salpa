...
original_dem <- exact_extract(dem_rast, original_sf |> st_buffer(12.5), "mean", progress = FALSE)
linearly_adjusted_dem <- exact_extract(dem_rast, linearly_adjusted_sf |> st_buffer(12.5), "mean", progress = FALSE )
```
